...
@Configuration
@Profile("test")
public class TestConfig implements CommandLineRunner {// vai popular meu banco de dados
    ...
    public void run(String... args) throws Exception {
        ...
        // instanciar 3 pedidos no formato iso 8601
        ...
        Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"),o1);//pagamentos duas horas dps
        //UM PARA UM nao chama o repository
        o1.setPayment(pay1);
